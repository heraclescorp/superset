...
export const listRows: Record<string, unknown>[] = [
  {
    ...
    END_TIME: null,
    GROUPS: '{"maybeEnableAprExperiment":[0,1,2,3,4,5],"+100bps":[6,7],"+200bps":[8,9]}',
    EXPOSED_COUNT: 26656,
    STATUS: 'running',
...
export const detailRowsSmall: Record<string, unknown>[] = [
  {
    ...
    START_TIME: '2025-12-01T08:00:00',
    END_TIME: '2026-02-01T08:00:00',
    IS_LEAD: 1, IS_PII: 1, IS_PQ: 1, IS_PQA: 0, IS_OFFER: 0,
    IS_ACCEPT: 0, IS_SCHED: 0, IS_NOTARY_STARTED: 0, IS_BOOKED: 0,
  },
  {
    EXPERIMENT_SPEC_ID: 104,
    EXPERIMENT_GROUP: 'IMPLICIT_CONTROL',
    ...
    START_TIME: '2025-12-01T08:00:00',
    END_TIME: '2026-02-01T08:00:00',
    IS_LEAD: 1, IS_PII: 1, IS_PQ: 0, IS_PQA: 0, IS_OFFER: 0,
    IS_ACCEPT: 0, IS_SCHED: 0, IS_NOTARY_STARTED: 0, IS_BOOKED: 0,
  },
  {
    EXPERIMENT_SPEC_ID: 104,
    ...
    START_TIME: '2025-12-01T08:00:00',
    END_TIME: '2026-02-01T08:00:00',
    IS_LEAD: 1, IS_PII: 0, IS_PQ: 0, IS_PQA: 0, IS_OFFER: 0,
    IS_ACCEPT: 0, IS_SCHED: 0, IS_NOTARY_STARTED: 0, IS_BOOKED: 0,
  },
  {
    EXPERIMENT_SPEC_ID: 104,
    ...
    START_TIME: '2025-12-01T08:00:00',
    END_TIME: '2026-02-01T08:00:00',
    IS_LEAD: 1, IS_PII: 1, IS_PQ: 1, IS_PQA: 1, IS_OFFER: 0,
    IS_ACCEPT: 0, IS_SCHED: 0, IS_NOTARY_STARTED: 0, IS_BOOKED: 0,
  },
  {
    EXPERIMENT_SPEC_ID: 104,
